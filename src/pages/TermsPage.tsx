...
export default function TermsPage() {
  ...
  const sections = [
    ...
    { title: "7. Support", content: "Community support is available through the public forum and GitHub issues. Commercial support, training, and consulting services are available through BITZ IT Consulting Ltd. Service level agreements (SLAs) are available for organizations requiring guaranteed response times." },
    { title: "8. Changes to Terms", content: "These terms may be updated from time to time. Continued use of the platform after changes constitutes acceptance of the updated terms. Material changes will be communicated through the platform and community channels. Last updated: February 2024." },
  ];
